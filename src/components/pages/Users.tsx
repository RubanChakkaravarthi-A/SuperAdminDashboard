...
const Users = () => {
  ...
  return <main className="page-shell mx-auto max-w-[1400px] px-6 py-10"><PageTitle title="User Management" description="Manage platform and tenant users, roles, and effective data access" action="+ Add User" onAction={() => setEditing(freshUser)} />
